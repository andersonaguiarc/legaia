...
**Resultado**: Documentos en 5 minutos por $19-49 vs. 3-7 días por $200-500.
...
│              │  │              │  │              │
│ • PostgreSQL │  │ • GPT-4      │  │ • Checkout   │
│ • Auth       │  │ • Turbo      │  │ • Webhooks   │
│ • Storage    │  │ • Prompts    │  │ • Subs       │
│ • RLS        │  │ • Templates  │  │              │
└──────────────┘  └──────────────┘  └──────────────┘
```
...
- **ADR-001**: Next.js App Router para SSR, SEO y DX
- **ADR-002**: Supabase sobre Firebase (PostgreSQL + RLS + costo)
- **ADR-003**: GPT-4 sobre alternativas (calidad legal superior)
- **ADR-004**: Serverless sobre tradicional (costo + escalabilidad)
- **ADR-005**: Generación síncrona (UX simple, <5s respuesta)

📄 [Ver ADRs completos](./docs/adr/)
...
```bash
git clone https://github.com/tu-usuario/legaia-mvp.git
cd legaia-mvp
```
